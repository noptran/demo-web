...
namespace SmartAdmin.WebUI.Extensions
{
    public static class IdentityExtensions
    {
        ...
        public static bool AuthorizeFor(this ListItem source, ClaimsPrincipal identity)
            => source.Roles.IsNullOrEmpty() || (source.Roles.HasItems() && identity.HasRole(source.Roles));
